        ...
        <?php endif; ?>
            ...
            <div class="box  span12">
                ...
                <div class="box-content">
                    <form action="<?php echo e(route('category.store')); ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
                        <fieldset>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts/backendLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lvEcommerce\Ecommerce\resources\views/admin/category/create.blade.php ENDPATH**/ ?>