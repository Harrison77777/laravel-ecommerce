		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="<?php echo e(route('admin.login.attempt')); ?>" method="post">
						<fieldset>
							<?php echo csrf_field(); ?>
					...
					<p>
						No problem, <a style="color:blue;" href="<?php echo e(route('admin.password.request')); ?>">click here</a> to get a new password.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
...
</html><?php /**PATH C:\xampp\htdocs\lvEcommerce\Ecommerce\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>