        ...
        <?php endif; ?>
            ...
            <div class="box  span12">
                ...
                <div class="box-content">
                    <form action="<?php echo e(route('productStore')); ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
                        <fieldset>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input class="input-xlarge" value="<?php echo e(old("price")); ?>" name="price" id="disabledInput" type="text" placeholder="Product price">
                            </div>
                          </div>
                          <div class="control-group">
                            <label class="control-label">Quantity</label>
                            <div class="controls">
                              <input class="input-xlarge" value="<?php echo e(old("quantity")); ?>" name="quantity" id="disabledInput" type="number" placeholder="Product quantity">
                            </div>
                          </div>
                          <div class="control-group">
                            <label class="control-label">Sale price</label>
                            <div class="controls">
                              <input class="input-xlarge" value="<?php echo e(old("sale_price")); ?>" name="sale_price" id="disabledInput" type="text" placeholder="Product price">
                            </div>
                          </div>
                          <div class="control-group hidden-phone">
                            <label class="control-label" for="textarea2">Description</label>
                            <div class="controls">
                            <textarea name="description"  class="cleditor" id="textarea2" rows="3"><?php echo e(old("description")); ?></textarea>
                            </div>
                          </div>
                          <div class="control-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts/backendLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lvEcommerce\Ecommerce\resources\views/admin/product/create.blade.php ENDPATH**/ ?>