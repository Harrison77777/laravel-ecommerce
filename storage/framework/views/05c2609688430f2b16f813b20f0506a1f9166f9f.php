			...
			<div class="container-fluid">
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> <?php echo e(Auth::user()->username); ?>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo e(route('admin.logout')); ?>"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
...
<?php /**PATH C:\xampp\htdocs\lvEcommerce\Ecommerce\resources\views/layouts/backendLayout.blade.php ENDPATH**/ ?>