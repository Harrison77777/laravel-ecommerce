		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="login-box">
                    ...
                    <h2>Admin reset password <span style=" margin-left:100px;"><a class="btn btn-info btn-sm" href="<?php echo e(route('admin.login')); ?>">Back to login</a></span></h2>
                    <div></div>
					<form class="form-horizontal" action="<?php echo e(route('admin.password.email')); ?>" method="post">
						<fieldset>
							<?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\lvEcommerce\Ecommerce\resources\views/admin/auth/forgot-password.blade.php ENDPATH**/ ?>