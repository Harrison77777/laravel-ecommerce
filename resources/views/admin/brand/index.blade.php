    ...
    <div class="row-fluid">
      ...
      @include('backendPartial.sidebar-left')
        ...
        <div style="margin-right:30px;" id="content" class="span12">
                ...
                @endif
            <div style="margin-left:3px; margin-bottom:5px;"><a class="btn btn-sm btn-success my-3" href="{{route('brand.create')}}">Add Brand</a></div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody style="text-align:center;">
                        ...
                        <tr style="text-align:center;">
                            <td style="text-align:center; vartical-align:center!important;" class="center">{{$loop->index +1}}</td>
                            <td>{{$brand->brand}}</td>
                            <td  style="display:inline-block; vartical-align:center!important;" class="center">
                                ...
                                document.getElementById('deleteForm-{{$brand->id}}').submit();
                                "
                                 class="btn btn-danger" href="index.php">
                                    <i class="halflings-icon white trash"></i>
                                </a>
                                <form id="deleteForm-{{$brand->id}}" action="{{route('brand.delete',$brand->id)}}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                </form>
                            </td>  
