...
<div class="container-fluid-full">
    <div class="row-fluid">
      ...
      @include('backendPartial.sidebar-left')
        ...
        @endforeach 
        @endif
            <div style="margin-left:30px; margin-bottom:5px;"><a class="btn btn-sm btn-success my-3" href="{{route('slide.index')}}">Back</a></div>
            ...
            <div class="box  span12">
                ...
                <div class="box-content">
                    <form action="{{route('slide.store')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                      @csrf
                        <fieldset>
