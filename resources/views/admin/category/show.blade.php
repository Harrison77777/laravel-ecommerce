    ...
    <div class="row-fluid">
      ...
      @include('backendPartial.sidebar-left')
        ...
        <div style="margin-right:30px;" id="content" class="span12">
            ...
            @endif
            <div style="margin-left:3px; margin-bottom:5px;"><a class="btn btn-sm btn-success my-3" href="{{route('category.index')}}">Back</a>
            </div>
            ...
            <div class="span12">
                ...
                <div class="box-content">
                    ...
                    <h4>Category slug: {{$category->slug}} </h4> 
                    <hr>
                    <h5>Category photo:  </h5> 
                    <img height="200" width="250" src="{{asset('uploads/category/'. $category->banner)}}" alt=""> 
                </div>
            </div><!--/span-->
        </div>
