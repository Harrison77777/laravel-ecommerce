		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="{{route('admin.login.attempt')}}" method="post">
						<fieldset>
							@csrf
					...
					<p>
						No problem, <a style="color:blue;" href="{{route('admin.password.request')}}">click here</a> to get a new password.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
