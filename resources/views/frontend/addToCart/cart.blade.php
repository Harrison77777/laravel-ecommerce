@extends('layouts.layout')
	...
	@section('content')
		<div class="container">
			...
			<input type="hidden" class="image_url" value="{{asset('uploads/product/')}}"/>
	<section id="cart_items">
		<div class="container">
				<input type="hidden" class="cart-products-show-url" value="{{route('show.cart.products')}}">
		...
		$.ajax({
			...
			success:function(data){
				...
				$.each(carts,function(k,cart){
					...
					showCartProduct +=	'<form id="cartQuantityUpdate" method="POST" action="'+'{{url('cart/frontend/addCart/update/')}}'+'/'+cart.id+'">';
					showCartProduct +=  '@csrf';
					...
					showCartProduct +='<a id="deleteCart" data-id="'+cart.id+'" class="btn btn-danger text-danger btn-sm" href="{{url('cart/frontend/addCart/delete')}}">x</a>';
					showCartProduct +=	'</td>';
					showCartProduct +=  '</tr>';
             ...
             $.ajax({
                ...
                success:function(data){
                    ...
                    if($.isEmptyObject(data.errorMsg)){
                        ...
                        {{--  console.log(data.cartQuantityCount);  --}}
